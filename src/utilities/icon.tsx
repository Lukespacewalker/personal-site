...
export const YoutubeIcon: React.FunctionComponent = (props) => {
  return (
    <a {...props} href="https://www.youtube.com/channel/UCdGwXjUz3JZhIk7b9vQRmCQ">
    <img id="youtube" src={yt_icon} style={{ height: `24px` }} />
  </a>
  );
};

export const InstagramIcon: React.FunctionComponent = (props) => {
  return (
    <a {...props} href="https://www.instagram.com/lukesp763/">
      <img src={instagram_icon} style={{ height: `24px`}} />
    </a>
  );
};

export const PxIcon: React.FunctionComponent = (props) => {
  return (
    <a {...props} href="https://500px.com/lukespacewalker">
      <svg
        style={{ height: `24px`, fill: `#2F2F2F` }}
