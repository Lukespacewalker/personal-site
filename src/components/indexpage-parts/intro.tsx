...
import { intro, introText, introImage,introSvg } from "./intro.module.scss";
      ...
      <div className={introText}>
        ...
        <div>
          <a href="#photography-+-3d-rendering" onClick={scrollTo}>
            📸 ถ่ายภาพท่องเที่ยว 🧑‍💻 สร้าง 3D Rendering
          </a>
        </div>
        <div>
          <a href="#projects" onClick={scrollTo}>
            🖥️ พัฒนาโปรแกรม และ 🛰️เว็บไซต์
          </a>
        </div>
        <div>
        ...
        <h4>ติดตาม</h4>
        <div>
          <a href="#คุย-com-กับหมอต้น" onClick={scrollTo}>
            <img className="w-8 inline-block mr-1" src={yt_icon} /> คุย Com กับหมอต้น
          </a>
        </div>
        <div>
